...
-- 2. Enable RLS and add policies for sensitive tables without RLS (excluding views)
...
-- Note: breach_summary is a view, cannot enable RLS on views
...
-- Note: high_priority_prospects is a view, cannot enable RLS on views
